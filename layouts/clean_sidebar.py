...
static_content = utils.load_content("static", environment)
dynamic_content = utils.load_content("dynamic", environment)
...
if home_button:
    ...
    content_id = utils.render_content_by_click(
    ...
    utils.render_content_by_key(
        content=dynamic_content, content_id=content_id, environment=environment
    )
else:
